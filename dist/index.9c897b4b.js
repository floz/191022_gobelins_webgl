...
})({"l4yut":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "0c11b9449c897b4b";
...
},{}],"4sCly":[function(require,module,exports) {
...
const setupProgram = ()=>{
    vShader = (0, _utilsJs.createShader)(gl, gl.VERTEX_SHADER, (0, _shadersJs.vert));
    fShader = (0, _utilsJs.createShader)(gl, gl.FRAGMENT_SHADER, (0, _shadersJs.frag));
    program = (0, _utilsJs.createProgram)(gl, vShader, fShader);
};
const getTriangleData = ()=>{
    ...
    for(let i = 0; i < 3; i++){
        ...
        data.push(-1 + Math.random() * 2, -1 + Math.random() * 2, color[0], color[1], color[2], -1 + Math.random() * 2, -1 + Math.random() * 2, color[0], color[1], color[2], -1 + Math.random() * 2, -1 + Math.random() * 2, color[0], color[1], color[2]);
    }
    return data;
};
const getRectData = ()=>{
...
},{"./shaders.js":"3qN7Z","./utils.js":"4XxAs","./mimi_256-512.jpg":"eUIxL"}],"3qN7Z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "vert", ()=>vert);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"dGrgp"}],"dGrgp":[function(require,module,exports) {
...
},{}],"4XxAs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const createProgram = (gl, vertexShader, fragmentShader)=>{
    ...
    if (didLink) return program;
    console.warn(gl.getProgramInfoLog(program));
    gl.deleteProgram(program);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"dGrgp"}],"eUIxL":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("12f8S") + "mimi_256-512.12bc9852.jpg" + "?" + Date.now();

},{"./helpers/bundle-url":"9kTCk"}],"9kTCk":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["l4yut","4sCly"], "4sCly", "parcelRequire94c2")

//# sourceMappingURL=index.9c897b4b.js.map
